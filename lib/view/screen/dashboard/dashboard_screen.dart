...
import 'package:flutter_makzan_ecommerce/view/screen/home/home_screens.dart';
import 'package:flutter_makzan_ecommerce/view/screen/home/widget/category_view.dart';
import 'package:flutter_makzan_ecommerce/view/screen/more/more_screen.dart';
...
class _DashBoardScreenState extends State<DashBoardScreen> {
    ...
    _screens = [
      ...
      singleVendor
          ...
          : Padding(
              ...
              child: CategoryView(isHomePage: false),
            ),
      singleVendor
  ...
  List<BottomNavigationBarItem> _getBottomWidget(bool isSingleVendor) {
    ...
    if (!isSingleVendor) {
      ...
      _list.add(_barItem(
          Images.more_filled_image, getTranslated('CATEGORY', context), 1));
      _list.add(
